...
class TextHandler(logging.Handler):
    ...
    def __init__(self, text):
        ...
        self.line_limitation = constants.LOG_LINE_LIMIT
        self.line_check = constants.LOG_LINE_CHECK
...
class Logger:
    ...
    def __init__(self, custom_handler=None):
        """initialization
        """
        log_folder = helper.ensure_folder_exists(os.path.join(constants.ROOT_PATH, constants.LOG_DIR_NAME))
        file_handler = logging.FileHandler(os.path.join(log_folder, constants.LOG_FILENAME), mode=constants.LOG_FILE_MODE)
